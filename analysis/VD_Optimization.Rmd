...
libPath<-"/home/lbraatz/R/x86_64-pc-linux-gnu-library/4.1"
withr::with_libpaths(new=libPath, devtools::install_github(repo = "LucianoRogerio/AlphaSimHlpR", ref = "MarninPkg", force = TRUE))
withr::with_libpaths(new=libPath, install.packages("RhpcBLASctl"))

library(AlphaSimR, lib.loc = "/home/lbraatz/R/x86_64-pc-linux-gnu-library/4.0/")
install_github(repo = "LucianoRogerio/AlphaSimHlpR", ref = "MarninPkg", force = TRUE)
library(AlphaSimHlpR, lib.loc = "/home/lbraatz/R/x86_64-pc-linux-gnu-library/4.0/")
