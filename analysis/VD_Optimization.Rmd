...
| :-----------------: | :----: | :-: | :---------------: | :----: | :-: | :-------------------: | :----: |
| **nTrainPopCycles** | 10     |     | **NChr**          | 18     |     | **genVar**            | 1500   |
| NYrsAsCandidates    | 2      |     | **effPopsize**    | 200    |     | gxeVar                | NULL   |
| maxTrainingPopSize  | 200    |     | **segSites**      | 1,650  |     | **gxyVar**            | 1500   |
| stageToGenotype     | CET    |     | **nQTL**          | 1,000  |     | gxlVar                | 750    |
| nParents            | 100    |     | **nSNP**          | 500    |     | **gxyxlVar**          | 300    |
| nCrosses            | 340    |     |                   |        |     | meanDD                | 0.23   |
| nProgeny            | 15     |     |                   |        |     | varDD                 | 0.05   |
...
bsp1 <- specifyBSP(schemeDF = schemeDF,
                   ...
                   stageToGenotype = "CET",
                   nParents = 100, nCrosses = 340, nProgeny = 15, nClonesToNCRP = 3,
