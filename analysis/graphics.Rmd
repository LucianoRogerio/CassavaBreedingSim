...
postBurnInIITAGS <- readRDS(here::here("output", "SimFeb", "postBurnIn_IITA_GS.rds"))
postBurnInIITAPS <- readRDS(here::here("output", "SimFeb", "postBurnIn_IITA_PS.rds"))
...
IITA1Yr <- readRDS(here::here("output", "SimJan", "postBurnIn_IITA1yr_GS.rds"))
IITA2Yr <- readRDS(here::here("output", "SimJan", "postBurnIn_IITA_GS.rds"))
IITA3Yr <- readRDS(here::here("output", "SimJan", "postBurnIn_IITA3yr_GS.rds"))
...
saveRDS(forSimPlotIITA_1_3_F1, file = here::here("output", "SimJan", "DataSimPlotIITA1_3_F1.rds"))
saveRDS(forSimPlotIITA_1_3_UYT, file = here::here("output", "SimJan", "DataSimPlotIITA1_3_UYT2.rds"))
```
